...
public:
    ...
    mempool_feehistogram getMempoolFeeHistogram() override {
        ...
        printf("getMempoolFeeHistogram start %lld\n", timestart);
...

        {
            ...
            printf("getMempoolFeeHistogram lock aquired, time: %lld\n", GetTimeMicros()-timestart);
            ...
            printf("getMempoolFeeHistogram loop done, time: %lld\n", GetTimeMicros()-timestart);
        }
        ...
        printf("getMempoolFeeHistogram end, time: %lld\n", GetTimeMicros()-timestart);
